...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (ContextCompat.checkSelfPermission(this,Manifest.permission.READ_MEDIA_AUDIO)!= PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(
                this, arrayOf(Manifest.permission.READ_MEDIA_AUDIO),PERMISSIONS_REQUEST_READ_MEDIA_AUDIO)
        }
        else{
            loadSongList()
        }
    ...
    private fun loadSongList() {
        ...
        val adapter = ArrayAdapter<String>(this, R.layout.design, R.id.text_view, songList)
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == PERMISSIONS_REQUEST_READ_MEDIA_AUDIO) {
